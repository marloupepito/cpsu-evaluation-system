...
import SidebarRight from './assets/components/sidebar-right/SidebarRight.vue'
import Header from './assets/components/header/Header.vue'
import TopMenu from './assets/components/top-menu/TopMenu.vue'
import ThemePanel from './assets/components/theme-panel/ThemePanel.vue'
