		...
		<div class="profile-content">
			...
			<div class="tab-content p-0">
				...
				<div class="row">
						...
						<div  class="col-md-3">
								<button class="btn btn-green btn-xs" @click="openAddSubject">ADD SUBJECT</button>
						</div>
				</div>
					<!-- BEGIN row -->
					<div class="row gx-1">
						...
						<div class="col-xl-4 col-lg-6 mb-1" v-for="(item, index) in loaded">
							<div class="card shadow  p-2  m-2 d-flex align-items-center card flex-row border-0 rounded">
								<a href="javascript:;">
